...
function (_Phaser$Scene) {
  ...
  _createClass(MenuScene, [{
    ...
    value: function create() {
      var menuBg = this.add.image(this.game.renderer.width / 2, this.game.renderer.height * 0.2, "logo").setDepth(1);
      var titleBg = this.add.image(0, 0, "title_bg").setOrigin(0).setDepth(0); //titleBg.setScale(2)
...
function (_Phaser$Scene) {
  ...
  _createClass(LoadScene, [{
    ...
    key: "create",
    value: function create() {
      this.scene.start(_CST.CST.SCENES.MENU, "Hello from load");
    }
  }]);
